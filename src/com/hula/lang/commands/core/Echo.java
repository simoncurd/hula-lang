...
/**
 * The Echo command writes a message to the log. <br/><br/>
 * 
 * Example Usage:<br/><br/>
 * 
 * Write an informational message<br/>
 * <code>Echo "this is a message"</code><br/><br/>
 * 
 * Write an informational message containing other variables<br/>
 * <code>Echo "my name is $name, nice to meet you"</code><br/><br/>
 * 
 * Write an informational message containing other variables<br/>
 * <code>Echo "my name is $person.name, nice to meet you"</code><br/><br/>
 * 
 * Write an error message<br/>
 * <code>Echo "something bad happened", type=error</code><br/><br/>
 * 
 * Write an error message as well as a stacktrace<br/>
 * <code>Echo "something bad happened", type=error, cause=ex</code><br/><br/>
 */
