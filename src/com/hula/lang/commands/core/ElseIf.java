...
/**
 * The ElseIf command evaluates a boolean expression to decide whether its body
 * will be executed. It always follows the {@link If} command or another ElseIf command. <br/>
 * <br/>
 * 
 * See also {@link If}, {@link Else}<br/>
 * <br/>
 * 
 * Example Usage:<br/>
 * <br/>
 ...
 */
@NoReturnParam
public class ElseIf extends AbstractCommand
{
	...
	public void updateBeanShellScript(BeanShellScript script)
	{
		...
		script.add("else if (" + conditionalClassName + ".evaluate(\"" + eval + "\", " + HulaConstants.runtimeConnector + "))");
		script.add("{");
