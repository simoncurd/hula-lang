...
/**
 * Responsible for parsing a Hula script to produce an executable version
 */
public interface HulaParser
{
	/**
	 ...
	 */
	HulaExecutable parse(String content) throws HulaParserException;
}
