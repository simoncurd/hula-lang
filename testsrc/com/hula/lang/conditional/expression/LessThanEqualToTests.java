...
public class LessThanEqualToTests extends BaseExpressionTestCase
{
	...
	public void testNumberGreaterThanNumber() throws Exception
	{
		...
		Assert.assertTrue(eval("33 <= 33"));
		Assert.assertTrue(eval("33.5 <= 33.5"));
		Assert.assertTrue(eval("33.54534534 <= 33.54534534"));
	...
	{
		rc.setVariable("thing", LessThanEqualToTests.class);
		try
		{
	...
	public void testBigDecimalVariableGreaterThanBigDecimalVariable() throws Exception
	{
		...
		rc.setVariable("weightb", new Float("32.4"));
		Assert.assertFalse(eval("$weighta <= $weightb"));
	}
	...
	@Test
	public void testNullLessThanEqualToNull() throws Exception
	{
		try
		{
	...
	@Test
	public void testBooleanLessThanEqualToNull() throws Exception
	{
		try
		{
	...
	@Test
	public void testNumberLessThanEqualToNull() throws Exception
	{
		try
		{
	...
	@Test
	public void testStringLessThanEqualToNull() throws Exception
	{
		try
		{
			Assert.assertTrue(eval("\"32\" <= null"));
	...
	@Test
	public void testVariableReferenceLessThanEqualToNull() throws Exception
	{
		try
		{
